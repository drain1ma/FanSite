...
namespace Fan_Website.Migrations
{
    ...
    [Migration("20210529230441_AddedOtherUserId")]
    partial class AddedOtherUserId
    {
            ...
            modelBuilder.Entity("Fan_Website.Forum", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ForumId = 1,
                            CreatedOn = new DateTime(2021, 5, 29, 23, 4, 41, 49, DateTimeKind.Utc).AddTicks(104),
            ...
            modelBuilder.Entity("Fan_Website.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 5, 29, 23, 4, 41, 48, DateTimeKind.Utc).AddTicks(8687),
            ...
            modelBuilder.Entity("Fan_Website.Screenshot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ScreenshotId = 6,
                            CreatedOn = new DateTime(2021, 5, 29, 19, 4, 41, 49, DateTimeKind.Local).AddTicks(1678),
                        ...
                        {
                            ScreenshotId = 9,
                            CreatedOn = new DateTime(2021, 5, 29, 19, 4, 41, 51, DateTimeKind.Local).AddTicks(1062),
